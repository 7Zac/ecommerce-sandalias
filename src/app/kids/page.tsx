    ...
    <main className="bg-slate-50">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-col gap-4 rounded-3xl bg-white p-6 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:p-8">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.24em] text-amber-700">Kids</p>
            <h2 className="mt-3 text-3xl font-semibold text-slate-900">Navegue pelos melhores modelos</h2>
            <p className="mt-2 text-sm text-slate-500">{sortedProducts.length} opções disponíveis para conforto, diversão e estilo.</p>
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <div className="inline-flex rounded-full bg-slate-100 p-2 text-sm text-slate-600 shadow-inner">
              ...
              <select
                ...
                className="ml-3 rounded-full border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 outline-none transition focus:border-amber-500 focus:ring-2 focus:ring-amber-100"
              >
        ...
        <div className="flex justify-around items-center p-4 w-full h-full mt-10">
          <div className="mt-8 flex flex-col gap-4">
            <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-orange-50 to-orange-100 p-5 shadow-sm transition-all duration-300 hover:shadow-lg hover:from-orange-100 hover:to-orange-200 hover:-translate-y-1">
              <p className="text-sm font-semibold text-orange-900">Frete Rápido</p>
              <p className="mt-2 text-sm text-orange-600">Entrega em até 3 dias úteis para todo o Brasil.</p>
            </div>
